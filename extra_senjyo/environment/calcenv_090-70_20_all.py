...
def run_composite():
    #read csvfile
    csvfile = '/mnt/jet12/makoto/extract_senjo/ext_sun_edd_a/csv/total_4-10_2000-2024_ratio2.0_allrain.csv'
    ...
    np.save("data/sum_ave_qV_090-70_20_all.npy", sum_ave_qV)
    np.save("data/sum_ave_U_090-70_20_all.npy", sum_ave_U)
    np.save("data/sum_ave_V_090-70_20_all.npy", sum_ave_V)
    np.save("data/sum_ave_MSLP_090-70_20_all.npy", sum_ave_MSLP)
